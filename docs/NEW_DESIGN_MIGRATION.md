...
**Advisor next:** available, no open thread — the mailbox entry above is the current ask. **PM next:** dispatch A/B/C from 2026-09-11#8 (A and B are higher-leverage, prioritize over C); races/leaderboards and lobby-collapse-cleanup still unscoped whenever there's bandwidth.
