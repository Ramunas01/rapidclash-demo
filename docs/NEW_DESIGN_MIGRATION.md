...
## Status snapshot — 2026-09-15 (D01-D13 shipped/deployed/closed; D14 shipped+deployed; D15 postponed; D16 shipped+deployed; D17 item 1 shipped+deployed, item 2 needed zero code; D18 — Related Games full rebuild — shipped in #608, merged, not yet deployed; a real pre-fetch-timing consequence found and fixed along the way, including a previously-flaky test now deterministic) — supersedes all earlier snapshots in this section
