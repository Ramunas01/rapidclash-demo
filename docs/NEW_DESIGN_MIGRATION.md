...
## Status snapshot — 2026-09-15 (D01-D13 fully shipped/deployed/closed; D14 shipped+deployed; D15 postponed pending Designer; D16 — opponent bar during matchmaking — shipped in #602, merged, not yet deployed; a new whole-file light-mode gap found in `GameHub.tsx` along the way, flagged as its own follow-up) — supersedes all earlier snapshots in this section
