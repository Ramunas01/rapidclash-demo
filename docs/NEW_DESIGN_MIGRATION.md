...
## Status snapshot — 2026-09-16 (D01-D20 all shipped, merged, and fully closed; D21 — Dice's reveal choreography — shipped, merged, and deployed (PR #622); D22 — Mines board clutter + colour check — shipped, merged, and deployed (PR #624); D23 — Mines bust-reveal, ALL 5 items — shipped, merged, and deployed (PR #625 items 1-3, PR #628 items 4-5); everything through D23 is now live at `rapidclash-00117-wvm` — D23 is fully closed, `2026-09-12#2`'s long-open items 3(a)/3(c) are finally closed too) — supersedes all earlier snapshots in this section
