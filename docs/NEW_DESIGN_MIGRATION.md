...
## Status snapshot — 2026-09-16 (D01-D20 all shipped and merged and fully closed; D21 — Dice's reveal has no drama, an Owner-directed rebuild — investigated and ready to ticket; a genuine new client-side reveal state machine, not a bug fix) — supersedes all earlier snapshots in this section
