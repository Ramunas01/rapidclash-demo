...
## Status snapshot — 2026-09-16 (D01-D18 all shipped, most deployed; D19 item 1 + ring shipped in #612, one real follow-up open — Dice's own losing cube number still needs #FF3E5E, PM's own re-verification during implementation reached the wrong conclusion on this one specific value) — supersedes all earlier snapshots in this section

**2026-09-16#1 — NEW, top item, a correction to PM's own correction. PM's `#612` report said Dice's `DICE_LOSE_RED` (#DC2626) was "already correct" and left it untouched — this is wrong; D19's own text is explicit that the cube number changes to #FF3E5E too, not just the bar ring. Full detail: `ADVISOR_TO_PM.md` 2026-09-16#1.**
